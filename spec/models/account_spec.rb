...
describe Account do
  ...
  describe "validation messages" do
    it "set for invalid characters" do
      ...
      expect(account.errors.messages[:subdomain]).to eq ["contains invalid characters"]
    end
    ...
    it "set for restricted subdomain" do
      ...
      expect(account.errors.messages[:subdomain]).to eq ["provided subdomain is restricted"]
    end
  end
end
